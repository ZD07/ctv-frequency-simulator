...
# Sources: BARB Establishment Survey, Ofcom Media Nations 2025
...
DEFAULT_PLATFORMS = [
    ...
    Platform(name="Disney+",    universe_size=7_500_000,  budget=10_000, cpm=28.0, frequency_cap=3),
    Platform(name="ITV X",      universe_size=12_000_000, budget=10_000, cpm=18.0, frequency_cap=4),
    Platform(name="Channel 4",  universe_size=12_000_000, budget=10_000, cpm=16.0, frequency_cap=4),
    Platform(name="Sky/NOW TV", universe_size=3_500_000,  budget=8_000,  cpm=22.0, frequency_cap=4),
    Platform(name="Paramount+", universe_size=1_500_000,  budget=5_000,  cpm=20.0, frequency_cap=3),
    Platform(name="Discovery+", universe_size=2_000_000,  budget=5_000,  cpm=15.0, frequency_cap=3),
]
